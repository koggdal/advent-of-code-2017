...
console.log('--- Part 1 ---');
console.log('Test (aa bb cc dd ee):', validate1('aa bb cc dd ee') ? 'OK' : 'FAIL');
console.log('Test (aa bb cc dd aa):', validate1('aa bb cc dd aa') ? 'FAIL' : 'OK');
console.log('Test (aa bb cc dd aaa):', validate1('aa bb cc dd aaa') ? 'OK' : 'FAIL');
console.log('Result:', part1(getInput()));

console.log('');
console.log('--- Part 2 ---');
console.log('Test (abcde fghij):', validate2('abcde fghij') ? 'OK' : 'FAIL');
console.log('Test (abcde xyz ecdab):', validate2('abcde xyz ecdab') ? 'FAIL' : 'OK');
console.log('Test (a ab abc abd abf abj):', validate2('a ab abc abd abf abj') ? 'OK' : 'FAIL');
console.log('Test (iiii oiii ooii oooi):', validate2('iiii oiii ooii oooi') ? 'OK' : 'FAIL');
console.log('Test (oiii ioii iioi iiio):', validate2('oiii ioii iioi iiio') ? 'FAIL' : 'OK');
